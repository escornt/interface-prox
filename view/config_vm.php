...
<!-- ID VM -->
            <div class="form-group has-feedback">
              <label for="ID VM" class="blu customfont" id="i1">ID VM <i class="fa fa-info"></i></label>
...
<!-- Nom VM -->
            <div class="form-group has-feedback">
              <label for="nom_vm" class="blu customfont" id="i2">Nom VM <i class="fa fa-info"></i></label>
...
<!-- Description -->
            <div class="form-group has-feedback">
              <label for="description" class="blu customfont" id="i3">Description <i class="fa fa-info"></i></label>
...
<!-- Mot de passe -->
            <div class="form-group has-feedback">
              <label for="password" class="blu customfont" id="i4">Mot de passe <i class="fa fa-info"></i></label>
...
<!-- Confimation mot de passe -->
            <div class="form-group has-feedback">
              <label for="password" class="blu customfont" id="i5">Confirmer mot de passe <i class="fa fa-info"></i></label>
...
<!-- Espace Disque -->
            <div class="form-group has-feedback">
              <label for="Espace disque" class="blu customfont" id="i6">Espace Disque (GB) <i class="fa fa-info"></i></label>
...
<!-- CPUs -->
            <div class="form-group has-feedback">
              <label for="CPU" class="blu customfont" id="i7">CPUs <i class="fa fa-info"></i></label>
...
<!-- RAM -->
            <div class="form-group has-feedback">
              <label for="RAM" class="blu customfont" id="i8">RAM (MB) <i class="fa fa-info"></i></label>
...
<!-- Swap -->
            <div class="form-group has-feedback">
              <label for="swap" class="blu customfont" id="i9">Swap (MB) <i class="fa fa-info"></i></label>
